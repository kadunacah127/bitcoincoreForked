...
{
    // EnsureWalletIsUnlocked(wallet); // Passphrase check removed for thesis
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    // EnsureWalletIsUnlocked(*pwallet); // Passphrase check removed for thesis
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    // if (sign) EnsureWalletIsUnlocked(*pwallet); // Passphrase check removed for thesis
