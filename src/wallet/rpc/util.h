...
extern const std::string HELP_REQUIRING_PASSPHRASE; // Now empty string - passphrase help removed for thesis
...
void EnsureWalletIsUnlocked(const CWallet&); // Now a no-op - passphrase check removed for thesis
